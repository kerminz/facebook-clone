  ...
  directive('jpNgBsAnimatedButton', [ '$timeout', function($timeout) {
    return {
      ...
      controller: [ '$scope', function($scope) {
        ...
        $scope.options = {
          buttonDefaultClass: $scope.options.buttonDefaultClass || 'btn-post-outline',
          buttonSubmittingClass: $scope.options.buttonSubmittingClass || 'btn-post-outline',
          buttonSuccessClass: $scope.options.buttonSuccessClass || 'btn-post-outline',
      ...
      template:
        '<button type="submit" class="btn {{buttonClass}} {{buttonSize}} {{onlyIcons}} btn-ng-bs-animated clearfix" ng-disabled="{{formIsInvalid}}" w-full>' +
          '<div align="center" class="text-xs-center">' +
      ...
      link: function(scope, element) {
        ...
        var setButtonTextFloatClass = function() {
          if (scope.iconsPosition === 'left') {
            return 'pull-right';
          } else if (scope.iconsPosition === 'center') {
